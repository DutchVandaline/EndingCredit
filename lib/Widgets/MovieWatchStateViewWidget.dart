...
class MovieWatchStateViewWidget extends StatelessWidget {
  final Movie movie;

  MovieWatchStateViewWidget({this.movie});
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      movie.ratings == 0.0 || movie.ratings == null
                          ? Text(
                              "평가해주세요!",
                              style: TextStyle(
                                  color: Colors.black,
