...
class _EditScreenForSearchScreenState extends State<EditScreenForSearchScreen> {
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        left: 20.0, right: 20.0, top: 35.0, bottom: 35.0),
                    child: Column(
                    ...
                    children: [
                      ...
                      RotatedBox(
                        ...
                        child: Text(
                          "\”",
                          style: Theme.of(context).textTheme.bodyText1.copyWith(
                              fontSize: 60.0, fontFamily: 'SongMyung'),
                        ),
                      ),
                      Padding(
  ...
  void updateMovie(BuildContext context) {
    Provider.of<MovieNotifier>(context, listen: false).updateMovie(
      widget.id,
      this.title,
      this.text,
      editTime,
      movieRating,
      this.text == '' || this.text == null ? 0 : 1,
      movieRating == 0.0 && this.text == '' && this.oneLinememo == '' ? 0 : 1,
      widget.movieOriginalTitle,
      this.oneLinememo,
    );
  }
